...
// file name for cropped image
   ...
   await sharp(originalImage).extract({ width: Math.floor(width * divisionOfWidth), height: Math.floor(height * divisionOfHeight) , left: Math.floor(x * divisionOfWidth), top: Math.floor(y * divisionOfHeight)}).toFile(outputImage)
